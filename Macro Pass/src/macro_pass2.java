...
public class macro_pass2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            String filename1 = System.getProperty("user.dir")+"/pass2_outputs/macro_pass2_output_MACHINE_CODE.txt";
            fw = new FileWriter(filename1);
            mcode_file = new BufferedWriter(fw);

            String filename2 = System.getProperty("user.dir")+"/pass2_outputs/APTAB.txt";
            FileWriter fw1 = new FileWriter(filename2);
            BufferedWriter aptab_file = new BufferedWriter(fw1);

            String filename3 = System.getProperty("user.dir")+"/pass2_outputs/EVTAB.txt";
            FileWriter fw2 = new FileWriter(filename3);
            BufferedWriter evtab_file = new BufferedWriter(fw2);

            String filename = System.getProperty("user.dir")+"/pass1_outputs/MDT.txt";
            File fr = new File(filename);
            RandomAccessFile mdt_file = new RandomAccessFile(fr, "r");

            String f1 = System.getProperty("user.dir")+"/pass1_outputs/PNTAB.txt";
            FileReader fr1 = new FileReader(f1);
            BufferedReader pntab_file = new BufferedReader(fr1);

            String f2 = System.getProperty("user.dir")+"/pass1_outputs/EVNTAB.txt";
            FileReader fr2 = new FileReader(f2);
            BufferedReader evntab_file = new BufferedReader(fr2);

            String f3 = System.getProperty("user.dir")+"/pass1_outputs/SSNTAB.txt";
            FileReader fr3 = new FileReader(f3);
            BufferedReader ssntab_file = new BufferedReader(fr3);

            String f4 = System.getProperty("user.dir")+"/pass1_outputs/MNT.txt";
            FileReader fr4 = new FileReader(f4);
            BufferedReader mnt_file = new BufferedReader(fr4);

            String f5 = System.getProperty("user.dir")+"/pass1_outputs/KPDTAB.txt";
            FileReader fr5 = new FileReader(f5);
            BufferedReader kpdtab_file = new BufferedReader(fr5);

            String f6 = System.getProperty("user.dir")+"/pass1_outputs/SSTAB.txt";
