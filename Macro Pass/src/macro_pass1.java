...
public class macro_pass1 {
    public static void main(String[] args) {
        ...
        try {
            ...
            String filename1 = System.getProperty("user.dir")+"/pass1_outputs/MDT.txt";
            ...
            mnt[1][1] = Integer.toString(1);
            mnt[2][1] = Integer.toString(1);
            mnt[3][1] = Integer.toString(1);		//1st column for values
            mnt[4][1] = Integer.toString(1);
            mnt[5][1] = Integer.toString(1);
            mnt[6][1] = Integer.toString(1);
            ...
            for (int j = 1; j < i; j += 2) 			//+2, because "," and "&" contain a null string between them. :  ,<null>&
            {
                ...
                if ((s1 = s.split("&|\\,")[j]).contains("="))
                {
                    ...
                    if((s1.split("=")).length>=2)
                        ...
                        KPDTAB.put(s1.split("=")[0], "NULL");	//param default value
                }
                else
                {
                    pp++;
